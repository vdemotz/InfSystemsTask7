package ch.ethz.globis.isk.mongo.validation;

import ch.ethz.globis.isk.config.PersistenceConfig;
import ch.ethz.globis.isk.service.*;
import ch.ethz.globis.isk.test.validation.PublicationWriteAccessTest;
...
@ActiveProfiles({ "test" })
public class MongoPublicationWriteAccessTest extends PublicationWriteAccessTest {
